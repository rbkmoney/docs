...
<p style="display:none" id="success">Test transaction completed, thanks. <a href="#">reset</a></p>
</div>
...
document.getElementById("applePay").onclick = function(evt) {
     ...
     logit('getShippingOptions: ' + shippingCountry );
        if( shippingCountry.toUpperCase() == "RU" ) {
    ...
    session.onshippingcontactselected = function(event) {
        ...
        var newTotal = { type: 'final', label: 'RBKmoney ApplePay', amount: runningTotal() };
