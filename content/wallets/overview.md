...
К Destination может быть привязано одно средство вывода в один момент времени. Таким средством может быть, например, банковская карта, счет в банке, номер телефона или электронный кошелек другой системы. На момент написания статьи поддерживается только одно средство вывода - банковская карта.
