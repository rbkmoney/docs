...
**Identity**, или цифровая личность — это структура `RBKmoney Wallet`, описывающая личность владельца кошелька, организацию, с которой были заключены договорные отношения, уровень идентификации (в соответствии со 161-ФЗ) и пр. К цифровой личности привязываются принадлежащие ей сущности - паспорт и СНИЛС, электронные кошельки, номера банковских карточек для вывода на них средств.
